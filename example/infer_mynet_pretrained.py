################################
# this file is to use pretrained 2d and 3d model for inference
################################
...
def get_state_dict(path):
    state_dict = torch.load(path) #16kps checkpoint pre trained on mpii
...
class MyNet(nn.Module):
    def __init__(self, adj, block) -> None:
        ...
        self.sthg.load_state_dict(get_state_dict('/netscratch/nafis/human-pose/new_code_to_git/stacked-human-pose/results/human36_gaus_1/model_2.pth'))
        self.MGCN = ModulatedGCN(adj, 384, num_layers=block, p_dropout=0, nodes_group=None)
        self.MGCN.load_state_dict(get_state_dict("/netscratch/nafis/human-pose/real_time_pose/results/MGCN_layer_2_16kps/MGCN_layer_2_16kps_epoch_25.pth"))
