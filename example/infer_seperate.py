###################################################
# this file is 2d on mpii and 3d on human36
...
from infer_mynet_pretrained import MyNet
...
def main():
    ...
    model = MyNet(adj, block=2).to('cuda')
    ...
    state_dict = torch.load('/netscratch/nafis/human-pose/new_code_to_git/stacked-human-pose/results/train_fullnet_mpii_only/model_3.pth') #mpii
    ...
    # fgor test images
    # image_name = '/netscratch/nafis/human-pose/new_code_to_git/stacked-human-pose/test_img/zoheb.png' #for test_img
    ...
    with torch.no_grad():
        ...
        plt.savefig('/netscratch/nafis/human-pose/new_code_to_git/stacked-human-pose/results/vis/heatmap_test_pre.png')
        plt.clf()
        kps_3d [1:] += kps_3d [:1]
        print(kps_3d)
        print("#"*100)
        ...
        cv2.imwrite('/netscratch/nafis/human-pose/new_code_to_git/stacked-human-pose/results/vis/pred_3dkps_test_pre.png', cvimg)
