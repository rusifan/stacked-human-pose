...
def get_state_dict():
    ...
    state_dict = torch.load("/netscratch/nafis/human-pose/new_code_to_git/stacked-human-pose/results/stacked8_16kps_fix/model_42.pth") #mpii only   
...
class MyNet(nn.Module):
    def __init__(self, adj, block, num_stacks=8) -> None:
        super(MyNet, self).__init__()
        self.sthg = hg(num_stacks=8, num_blocks=1, num_classes=16)
