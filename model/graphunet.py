...
class GraphUNet(nn.Module):
    ...
    def __init__(self, in_features=2, out_features=3):
        ...
        self.A_0 = Parameter(torch.eye(16).float(), requires_grad=True)
        ...
        self.gconv1 = GraphConv(in_features, 2)  # 29 = 21 H + 8 O
        self.pool1 = GraphPool(16, 15)
...
class GraphNet(nn.Module):
    ...
    def __init__(self, in_features=2, out_features=2):
        ...
        self.A_hat = Parameter(torch.eye(16).float(), requires_grad=True)
        
        # before changes 2/7/2023
        # self.gconv1 = GraphConv(in_features, 128)
        # self.gconv2 = GraphConv(128, 16)
        # self.gconv3 = GraphConv(16, out_features, activation=None)
        

        self.gconv0 = GraphConv(in_features, 1024)
        self.gconv1 = GraphConv(1024, 128)
        self.gconv2 = GraphConv(128, 16)
        self.gconv3 = GraphConv(16, out_features, activation=None)
    ...
    def forward(self, X):
        ...
        X_0 = self.gconv0(X, self.A_hat)
        # import pdb; pdb.set_trace()
        X_1 = self.gconv1(X_0, self.A_hat)
        X_2 = self.gconv2(X_1, self.A_hat)
        X_3 = self.gconv3(X_2, self.A_hat)
