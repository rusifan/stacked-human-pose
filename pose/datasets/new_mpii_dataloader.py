...
class Mpii(data.Dataset):
    def __init__(self,image_path,anno_path,inp_res,out_res,sigma,
                 scale_factor,rot_factor,is_train,label_type):
    ...
    def __getitem__(self, index):
        ...
        return inp, target, meta, img_path
...
if __name__ == '__main__':
    image_path = "/netscratch/nafis/human-pose/pytorch-pose/data/mpii/images"
    annotation_path = "/netscratch/nafis/human-pose/pytorch-pose/data/mpii/mpii_annotations.json"
    inp_res = 256
    out_res = 64
    scale_factor = 0.25
    rot_factor = 0
    ...
    label_type = 'Gaussian'
    sigma = 1
    dataset = Mpii(image_path, annotation_path, inp_res,
                   out_res,sigma, scale_factor, rot_factor, is_train, label_type)
    img = dataset[0][0]
    print(img.shape)
    heatmap = dataset[0][1]
    print(heatmap.shape)